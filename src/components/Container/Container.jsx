  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://github.com/Sumit-Pandey-07/PathFinding-Visualizer"
        />
        <meta
          property="og:image"
        />
      ...
      <footer className="footer">
        <p className="footer__author">Made by Sumit Pandey</p>
        <a
          href="https://github.com/Sumit-Pandey-07/PathFinding-Visualizer"
          target="_blank"
